...
const PICKS = [
  ...
  { id:"tp2", title:"Couple Card Game", price:"₺399", merchant:"Trendyol", tag:"games, conversation", url:"/go/aff/cards", image:"/products/cards.jpg" },
  ...
  { id:"tp6", title:"Conversation Prompts", price:"₺279", merchant:"Hepsiburada", tag:"talk, connection", url:"/go/aff/cards", image:"/products/cards.jpg" },
];
