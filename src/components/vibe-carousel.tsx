...
const DATA: Record<"cozy"|"adventurous"|"creative", any[]> = {
  cozy: [
    ...
    { id:"cz3", title:"Minimalist Journal", price:"₺249", merchant:"Hepsiburada", tag:"books", url:"/go/aff/journal",  image:"/products/journal.jpg" },
  ],
  adventurous: [
    { id:"ad1", title:"Action Card Game",  price:"₺349", merchant:"Trendyol", tag:"adventure", url:"/go/aff/cards",   image:"/products/cards.jpg" },
  ...
  creative: [
    { id:"cr1", title:"Minimalist Journal",     price:"₺249", merchant:"Hepsiburada", tag:"writing", url:"/go/aff/journal", image:"/products/journal.jpg" },
    { id:"cr2", title:"Conversation Prompts",   price:"₺279", merchant:"Hepsiburada", tag:"ideas",   url:"/go/aff/cards",   image:"/products/cards.jpg" },
